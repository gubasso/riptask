...
This document governs how specifications in `docs/spec/` are managed throughout the riptask development lifecycle. It applies to both LLM agents and human contributors.
...
- [[archive/13-llm-agent-integration]] — How agents interact with the riptask system (complementary to §0.7 which covers how agents interact with specs)
